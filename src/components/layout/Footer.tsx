...
const socialLinks = [
  {
    platform: 'LinkedIn',
    href: 'https://www.linkedin.com/in/abdullahtayyabofficial/',
    icon: (
  ...
  {
    platform: 'Facebook',
    href: 'https://www.facebook.com/i.abdullahtayyabofficial',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    platform: 'Instagram',
    href: 'https://www.instagram.com/abdullahtayyab.official/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 mb-12">
          ...
          <div>
            <Link
              href="/"
              className="font-heading font-semibold text-xl text-[var(--color-brand-dark)] tracking-tight"
            >
              <GradientText>Abdullah Tayyab</GradientText>
            </Link>
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-[var(--color-text-secondary)] hover:text-[var(--color-brand-light)] transition-colors duration-150"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <Link
              href="/#contact"
              className="inline-flex items-center gap-2 text-sm font-medium text-[var(--color-brand-dark)] hover:text-[var(--color-brand-light)] transition-colors"
            >
              Book a Call
        ...
        <div className="pt-8 border-t border-[var(--color-border)] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[var(--color-text-muted)]">
            © {year} Abdullah Tayyab. All rights reserved.
          </p>
          <p className="text-xs text-[var(--color-text-muted)]">
